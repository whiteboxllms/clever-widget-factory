...
CREATE TABLE public.issues (
  ...
  action_required action_required_type NULL,
  workflow_status workflow_status_type NOT NULL DEFAULT 'reported'::workflow_status_type,
...
-- Migrate tool_issue_history to issue_history with proper column mapping
INSERT INTO public.issue_history (
  id, issue_id, changed_by, changed_at, created_at, old_status, 
  new_status, field_changed, old_value, new_value, notes
)
SELECT 
  id, issue_id, changed_by, changed_at, created_at, old_status,
  new_status, field_changed, old_value, new_value, notes
