-- First, remove defaults that will conflict with the enum change
...
-- Set new default for condition
ALTER TABLE public.tools ALTER COLUMN condition SET DEFAULT 'optimal'::tool_condition;
