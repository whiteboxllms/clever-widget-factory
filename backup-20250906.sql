...
CREATE OR REPLACE TRIGGER "profile_role_update_check" BEFORE UPDATE ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."prevent_unauthorized_role_changes"();
...
CREATE POLICY "Any authenticated user can create issues" ON "public"."issues" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() IS NOT NULL));



CREATE POLICY "Authenticated users can create action scores" ON "public"."action_scores" FOR INSERT WITH CHECK (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Authenticated users can manage parts" ON "public"."parts" USING (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "Authenticated users can manage tools" ON "public"."tools" TO "authenticated" USING (("auth"."uid"() IS NOT NULL)) WITH CHECK (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Authenticated users can update action scores" ON "public"."action_scores" FOR UPDATE USING (("auth"."uid"() IS NOT NULL));



CREATE POLICY "Authenticated users can update issues" ON "public"."issues" FOR UPDATE TO "authenticated" USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Authenticated users can update tasks" ON "public"."actions" FOR UPDATE TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated users can view action scores" ON "public"."action_scores" FOR SELECT USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Authenticated users can view basic profile info" ON "public"."profiles" FOR SELECT USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Authenticated users can view issues" ON "public"."issues" FOR SELECT TO "authenticated" USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Authenticated users can view mission tasks" ON "public"."actions" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated users can view missions" ON "public"."missions" FOR SELECT USING (("auth"."uid"() IS NOT NULL));



CREATE POLICY "Authenticated users can view parts" ON "public"."parts" FOR SELECT USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Authenticated users can view tools" ON "public"."tools" FOR SELECT TO "authenticated" USING (("auth"."uid"() IS NOT NULL));



CREATE POLICY "Leadership and creators can update missions" ON "public"."missions" FOR UPDATE USING ((("created_by" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."user_id" = "auth"."uid"()) AND ("profiles"."role" = 'leadership'::"text"))))));



CREATE POLICY "Leadership can create missions" ON "public"."missions" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."user_id" = "auth"."uid"()) AND ("profiles"."role" = 'leadership'::"text")))));
...
CREATE POLICY "Leadership can manage all strategic attributes" ON "public"."worker_strategic_attributes" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."user_id" = "auth"."uid"()) AND ("profiles"."role" = 'leadership'::"text")))));



CREATE POLICY "Leadership can manage mission tasks" ON "public"."actions" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."user_id" = "auth"."uid"()) AND ("profiles"."role" = 'leadership'::"text")))));
...
CREATE POLICY "QA can provide feedback on missions" ON "public"."missions" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."user_id" = "auth"."uid"()) AND ("profiles"."role" = ANY (ARRAY['leadership'::"text", 'qa'::"text"]))))));
...
CREATE POLICY "Tool keepers can manage issue requirements" ON "public"."issue_requirements" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."user_id" = "auth"."uid"()) AND ("profiles"."role" = ANY (ARRAY['leadership'::"text", 'admin'::"text"]))))));
